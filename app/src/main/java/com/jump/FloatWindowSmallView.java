...
public class FloatWindowSmallView extends LinearLayout {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (Math.abs(xDownInScreen - event.getRawX())<20
                        && Math.abs(yDownInScreen - event.getRawY() + getStatusBarHeight()) < 20) {
                    if (listener != null) {
                        listener.click();
                    }
    ...
    public void Set_msg(String msg, int layoutResId,
                        int rootLayoutId) {
        View view = findViewById(rootLayoutId);

        TextView percentView = (TextView) findViewById(R.id.percent);
        percentView.setText(msg);
    }
